...
<%@ taglib prefix="jstlPre" uri="http://java.sun.com/jsp/jstl/core"%>
...
<body>
	<div ng-controller="taskManagerController">
		...
		<a
			href="http://www.programming-free.com/2014/06/crud-springmvc-restful-webservices-angularjs.html"
			class="button-red"
			...
			<div class="panel-body">
				<div class="task" ng-repeat="task in tasks">
					...
					<div ng-if="task.taskStatus=='COMPLETED'">
						<a href="#" class="checkedClass"> {{task.taskName}} {{task.userName}}<span
							class="action-status">{{task.taskStatus}}</span>
						</a>
					</div>
					<div ng-if="task.taskStatus=='ACTIVE'">
						<a href="#" class="uncheckedClass"> {{task.taskName}} {{task.userName}}<span
							class="action-status">{{task.taskStatus}}</span>
						</a>
					</div>
				</div>
